...
function Welcome() {
  return(
    <div tw="w-screen h-screen bg-yellow-300">
      <h1 tw="text-center pt-48 pb-24 text-7xl">Welcome to <span tw="text-green-800">Your Board</span>.</h1>
      ...
      <ul tw="flex justify-center">
        ...
        <div tw="pl-5">Create a new <a href="figma.com" tw="text-purple-900 underline">Figma project</a></div>
        </span>
