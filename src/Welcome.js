...
function Welcome() {
  return(
    <div className="welcomeColor" style={{width:'100vh', height:'100vh'}}>
      ...
      <span><p className="one">1</p></span><li className="second">Create a new Figma project</li>
      <span><p className="two">2</p></span><li className="third">Share a link with edit access</li>
